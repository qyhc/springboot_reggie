 ...
 * 主要作用：Spring MVC将使用这个自定义的转换器来处理HTTP请求和响应中的JSON数据。
 * 当控制器返回一个Java对象时，它会将其转换为JSON字符串，并在响应中返回；当请求中包含JSON数据时，它会将JSON数据转换为Java对象。
 */
public class JacksonObjectMapper extends ObjectMapper {
    ...
    public JacksonObjectMapper() {
        ...
        dateFormat.setTimeZone(TimeZone.getTimeZone("UTC")); // 设置时区，根据你的需求设置
        // // 配置日期格式
